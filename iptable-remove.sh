...
echo "80 loopback"
iptables -t nat -D OUTPUT -p tcp -o lo --dport 80 -j REDIRECT --to-port 8080
...
echo "Loopback"
iptables -t nat -D OUTPUT -p tcp -o lo --dport 443 -j REDIRECT --to-port 8443
